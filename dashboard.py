...
NAME_MAP: dict[str, str] = {
    ...
    "Гончаренко Олексій": "Honcharenko Oleksiy",
    "Гордон Дмитро": "Gordon Dmytro",
    "Давидюк Микола": "Davydiuk Mykola",
    ...
    "Кузик Петро": "Kuzyk Petro",
    "Кулеба Дмитро": "Kuleba Dmytro",
    "Кім Віталій": "Kim Vitaliy",
    "Лаченков Ігор": "Lachenkov Ihor",
    ...
    "Федоров Михайло": "Fedorov Mykhailo",
    "Чмут Тарас": "Chmut Taras",
    "Чорногоренко Катерина": "Chornohorenko Kateryna",
